...
(def ^:private pom-template
  [[:description "Thin Clojure client for Google GenAI / Vertex AI with Malli-driven structured output."]
   [:url "https://github.com/lukaszkorecki/vortex"]
   [:licenses
    [:license
     [:name "MIT"]
   ...
   [:scm
    [:url "https://github.com/lukaszkorecki/vortex"]
    [:connection "scm:git:git://github.com/lukaszkorecki/vortex.git"]
    [:developerConnection "scm:git:ssh://git@github.com/lukaszkorecki/vortex.git"]]])
